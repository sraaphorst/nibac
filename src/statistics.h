...
//
// A class to store statistical information for the branch-and-cut
// algorithm.
//
// $Author$
// $Date$
...
public:
 ...
 public:
  ...
  inline void reportNonCanonicalDepth(unsigned long p) { if (p > nonCanonicalMaximumDepth) nonCanonicalMaximumDepth = p; }
