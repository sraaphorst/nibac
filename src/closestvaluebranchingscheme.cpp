...
std::map< std::string, std::pair< std::string, std::string > > ClosestValueBranchingSchemeCreator::getOptionsMap(void)
{
  ...
  optionsMap[std::string("V")] =
    std::pair< std::string, std::string >(std::string("Value: the earliest variable in the selected variable order closest "
