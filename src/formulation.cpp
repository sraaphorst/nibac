...
bool Formulation::checkPartialFeasibility(short int *variableValues)
{
  ...
  for (; bconsIter != econsIter; ++bconsIter) {
    ...
    for (; bposIter != eposIter; ++bposIter, ++bcoefIter) {
      minv += (variableValues[*bposIter] == -1 ? (*bcoefIter < 0 ? *bcoefIter : 0) : *bcoefIter * variableValues[*bposIter]);
      maxv += (variableValues[*bposIter] == -1 ? (*bcoefIter > 0 ? *bcoefIter : 0) : *bcoefIter * variableValues[*bposIter]);
    }
