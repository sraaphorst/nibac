...
// Instead, this is a group that is generated by a number of permutations. This
// is a n abstract class that contains the functionality needed to calculate
// symmetry groups. The Schreier-Sims scheme is an example of a concrete
