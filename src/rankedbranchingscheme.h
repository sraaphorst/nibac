...
// This performs the basics of Margot's ranked branching scheme,
// implementing the rank vector and branching in the forced
// fashion when necessarily while leaving the choice arbitrary
// when possible. When branching can be done freely, the abstract
// method chooseBranchingVariableIndex is called and the rank
// vector is modified appropriately.
//
// $Author$
// $Date$
