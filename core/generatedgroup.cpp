...
void GeneratedGroup::findSymmetryGroup3(Formulation &ilp)
{
  ...
  std::map< int, std::set< int > >::iterator msbeginIter = sorted.begin();
  std::map< int, std::set< int > >::iterator msendIter   = sorted.end();
  ...
  for (; cbeginIter != cendIter; ++cbeginIter) {
    ...
    for (; msbeginIter != msendIter; ++msbeginIter) {
      ...
      // colour class.
      std::vector< std::set< int > >::iterator ccbeginIter = colourclasses.begin();
      std::vector< std::set< int > >::iterator ccendIter   = colourclasses.end();
  ...
  std::map< int, std::map< int, std::set< int > > >::iterator sortedcbeginIter = sortedconstraints.begin();
  std::map< int, std::map< int, std::set< int > > >::iterator sortedcendIter   = sortedconstraints.end();
  for (; sortedcbeginIter != sortedcendIter; ++sortedcbeginIter) {
    std::map< int, std::set< int > > &tmpmap = (*sortedcbeginIter).second;
    std::map< int, std::set< int > >::iterator tmpbeginIter = tmpmap.begin();
    std::map< int, std::set< int > >::iterator tmpendIter   = tmpmap.end();
