...
//
// This is a simple standardized command-line interface that
// can be used to configure an instance of BACOptions or
// MargotBACOptions, saving the user the trouble of doing so.
//
// $Author$
// $Date$
