...
//
// Class to represent all the data in a single node of the ILP branch and
// cut tree.
//
// $Author$
// $Date$
...
class Node
{
 ...
 public:
  ...
  // TODO: Do we need this?
  inline void setNumber0FixedVariables(int pnumber0FixedVariables) { number0FixedVariables = pnumber0FixedVariables; }
  ...
  virtual void addCut(Constraint*);
  virtual void removeCut(Constraint*);

  // Set the solution value to the partial solution.
  virtual void setSolutionToPartial(void);

  virtual inline Group *getSymmetryGroup() { return group; }
};
