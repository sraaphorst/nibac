...
//
// NOTE: superduper MUST be initialized with params at least v and k prior to
// creating any objects of this class, as we rely on the C array of combinations
// to exist.
//
// $Author$
// $Date$
...
class BlockGroup : public SchreierSimsGroup
{
 public:
